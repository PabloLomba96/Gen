          ...
          <div className="space-y-8 animate-fade-up">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span className="text-sm">Máster Infantojuvenil + General Sanitario</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-base px-8 h-14 shadow-lg hover:shadow-xl transition-all group">
                Reservar Primera Consulta
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="lg" variant="outline" className="text-base px-8 h-14 border-2 hover:bg-secondary group">
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map(i => <div key={i} className="w-10 h-10 rounded-full bg-secondary border-2 border-background flex items-center justify-center">
          ...
          animationDelay: '0.2s'
            ...
            <div className="relative">
              ...
              <div className="relative aspect-square max-w-md mx-auto">
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-primary/20 to-accent/20" style={{
                transform: 'rotate(3deg)'
              }} />
                <div className="relative h-full rounded-3xl bg-card overflow-hidden shadow-2xl border border-border flex items-center justify-center p-8" style={{
                boxShadow: 'var(--shadow-card)'
              }}>
                  <img src={logoPatricia} alt="Patricia Martínez Psicología - Logo con manos que se encuentran" className="w-full h-full object-contain" />
                </div>
              </div>

              {/* Floating Cards */}
              <div className="absolute -left-4 top-1/4 bg-card rounded-2xl p-4 shadow-xl border border-border animate-float" style={{
              boxShadow: 'var(--shadow-card)'
            }}>
              ...
              <div className="absolute -right-4 bottom-1/4 bg-card rounded-2xl p-4 shadow-xl border border-border animate-float" style={{
              animationDelay: '2s',
              boxShadow: 'var(--shadow-card)'
            }}>
                <div className="flex items-center gap-3">
