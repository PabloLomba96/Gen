        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-500/20">
              ...
              <span className="text-sm font-medium text-foreground">@patri_psicologia</span>
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-foreground">
              De los memes a la terapia
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Mi contenido ayuda a millones de personas a identificar que "no están solos". 
              Pero hay mucho más que puedo ofrecerte.
            </p>
          </div>
