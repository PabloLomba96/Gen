...
export const services: ServiceData[] = [
  // ─── ADULTOS ───
  {
    ...
    symptoms: [
      ...
      'La autoexigencia te agota y vives en un estado de urgencia constante',
      'Te cuesta gestionar el estrés del día a día',
      'Has perdido la motivación o el sentido en tu vida',
      'Tu autoimagen no refleja quién eres realmente',
      ...
      'Necesitas transformar tu diálogo interno en inteligencia emocional',
    ],
    color: 'primary',
