...
const Cookies = () => {
  useEffect(() => {
    document.title = 'Política de Cookies — Gen Centro de Psicología';
  }, []);
      ...
      <main className="pt-20">
        <section className="py-16 bg-gradient-to-b from-secondary/50 to-background">
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-display font-bold text-foreground">Política de Cookies</h1>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto space-y-8 text-muted-foreground text-sm leading-relaxed">
              ...
              <div>
                ...
                <p>Puedes configurar tu navegador para rechazar la instalación de cookies o para que te avise cuando un sitio web intente instalarlas. Ten en cuenta que, si desactivas las cookies técnicas, es posible que algunas funcionalidades del sitio no estén disponibles.</p>
              ...
              <p className="text-xs text-muted-foreground/60 pt-4 border-t border-border">Última actualización: marzo de 2026</p>
            </div>
          </div>
        </section>
      </main>
