...
const Privacidad = () => {
  useEffect(() => {
    document.title = 'Política de Privacidad — Gen Centro de Psicología';
  }, []);
      ...
      <main className="pt-20">
        <section className="py-16 bg-gradient-to-b from-secondary/50 to-background">
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-4xl sm:text-5xl font-display font-bold text-foreground">Política de Privacidad</h1>
          </div>
        </section>
